...
Ext.define("Ext.locale.ko.data.validator.Length", {
	...
	minOnlyMessage: "길이는 {0} 이상이어야 합니다.",
	maxOnlyMessage: "길이는 {0} 이상 초과할 수 없습니다.",
	bothMessage: "길이는 {0} ~ {1} 에 해당합니다."
});

Ext.define("Ext.locale.ko.data.validator.Range", {
	override: "Ext.data.validator.Range",
	minOnlyMessage: "{0} 이상이어야 합니다.",
	maxOnlyMessage: "{0} 이상 초과할 수 없습니다.",
	bothMessage: "{0} ~ {1} 에 해당합니다.",
	nanMessage: "숫자만 입력가능합니다."
});
...
Ext.define("Ext.locale.ko.form.Basic", {
...
Ext.define("Ext.locale.ko.grid.BooleanColumn", {
...
Ext.define("Ext.locale.ko.grid.NumberColumn", {
	override: "Ext.grid.NumberColumn",
	format: "0,000",
	//	format: "0,000.00",
});

Ext.define("Ext.locale.ko.grid.DateColumn", {
	override: "Ext.grid.DateColumn",
	format: "Y-m-d"
});

Ext.define("Ext.locale.ko.form.field.Time", {
	override: "Ext.form.field.Time",
	minText: "{0} 시간보다 크거나 같아야 합니다.",
	maxText: "{0} 시간보다 작거나 같아야 합니다.",
	invalidText: "{0} 은(는) 유효한 시간이 아닙니다.",
	format: "g:i A",
	altFormats: "g:ia|g:iA|g:i a|g:i A|h:i|g:i|H:i|ga|ha|gA|h a|g a|g A|gi|hi|gia|hia|g|H"
});

Ext.define("Ext.locale.ko.form.field.File", {
	override: "Ext.form.field.File",
	buttonText: "검색..."
});

Ext.define("Ext.locale.ko.form.CheckboxGroup", {
	override: "Ext.form.CheckboxGroup",
	blankText: "적어도 1개 항목을 선택해주세요."
});

Ext.define("Ext.locale.en.form.RadioGroup", {
	override: "Ext.form.RadioGroup",
	blankText: "항목을 선택해주세요."
});
...
Ext.define("Ext.locale.ko.grid.filters.filter.Boolean", {
	override: "Ext.grid.filters.filter.Boolean",
	yesText: "예",
	noText: "아니오"
});

Ext.define("Ext.locale.ko.grid.filters.filter.Date", {
...
Ext.define("Ext.locale.ko.grid.filters.filter.List", {
	override: "Ext.grid.filters.filter.List",
	loadingText: "로딩중..."
});

Ext.define("Ext.locale.ko.grid.filters.filter.Number", {
	override: "Ext.grid.filters.filter.Number",
	emptyText: "숫자로 입력해주세요..."
});
