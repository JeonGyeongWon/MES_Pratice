...
function btnSav1Click(button, e, eOpts) {
    //     var model1 = Ext.getStore(gridnms["store.1"]).getById(Ext.getCmp(gridnms["views.bigclass"]).selModel.getSelection()[0].id);
    var count = 0,
    msg = null;
...
function onBigclassClick(dataview, record, item, index, e, eOpts) {
    ...
    //     Ext.getStore(gridnms["store.2"]).proxy.setExtraParam('bigcode', BigcodeVal);
...
function setValues_Item() {
    ...
    gridnms["grid.4"] = "ItemProductList";
    gridnms["grid.5"] = "modelLov";
    gridnms["grid.6"] = "customerLov";
    gridnms["grid.7"] = "uomLov";
    gridnms["grid.8"] = "maketypeLov";
    gridnms["grid.9"] = "itemTypeLov";
    gridnms["grid.10"] = "shippingGroupLov";
    ...
    gridnms["models.item"].push(gridnms["model.9"]);
    gridnms["models.item"].push(gridnms["model.10"]);
    ...
    gridnms["stores.item"].push(gridnms["store.9"]);
    gridnms["stores.item"].push(gridnms["store.10"]);
            ...
            editor: {
                ...
                listeners: {
                    select: function (value, record, eOpts) {
                        ...
                        model.set("LABELCODE", record.data.VALUE);
                    },
                },
                listConfig: {
                    loadingText: '검색 중...',
            ...
            editor: {
                ...
                listeners: {
                    select: function (value, record, eOpts) {
                        ...
                        model.set("MAKETYPE", record.data.VALUE);
                    },
                },
                listConfig: {
                    loadingText: '검색 중...',
...
function btnAdd4Click(o, e) {
    ...
    model.set("PROCESSINSPECTIONYN", "N");
    model.set("SHIPMENTINSPECTIONYN", "N");
    model.set("USEYN", "Y");
...
function onItemClick(dataview, record, item, index, e, eOpts) {
    ...
    var maketype = record.data.MAKETYPE;
    ...
    case "UOMNAME":
        ...
        extGridSearch(sparams3, gridnms["store.7"]);
        break;
    case "CUSTOMERNAME":
        var sparams2 = {
            ORGID: orgid,
    ...
    case "MAKETYPENAME":
        ...
        extGridSearch(sparams4, gridnms["store.8"]);
        break;
    default:
        break;
    }
    ...
    Ext.define(gridnms["store.10"], {
        ...
        constructor: function (cfg) {
            ...
            me.callParent([Ext.apply({
                        ...
                        proxy: {
                            type: 'ajax',
                            url: "<c:url value='/searchShippingItemGroup.do' />",
                            extraParams: {
                                ORGID: $("#searchOrgId").val(),
                                COMPANYID: $("#searchCompanyId").val(),
                                BIGCD: 'OM',
                                MIDDLECD: 'SHIPPING_ITEM_GROUP',
                            },
                            reader: gridVals.reader,
                        }
                    }, cfg)]);
                    ...
                    listeners: {
                        refresh: function (dataView) {
                            Ext.each(dataView.panel.columns, function (column) {
                                ...
                                if (column.dataIndex.indexOf('MANAGEMENTNUMBER') >= 0) {
                                    column.autoSize();
                                    column.width += 5;
                                    if (column.width < 100) {
                                        column.width = 100;
...
function fn_excel_download() {
    ...
    go_url("<c:url value='/item/prod/ExcelDownload.do?ORGID='/>" + orgid + ""
         + "&COMPANYID=" + companyid + ""
         + "&ITEMCODE=" + itemcode + ""
         + "&GROUPCODE=" + "${searchVO.GROUPCODE}" + ""
         + "&TITLE=" + title + "");
                ...
                <div>
                    ...
                    <table class="tbl_type_view" border="1" style="margin-top: 10px;">
                        ...
                        <tr style="height: 34px;">
                                ...
                                <td>
                                      <input type="text" id="searchModelnm" name="searchModelnm" class="input_center" onkeyup="Upper(event,this)" style="width: 80%;">
                                </td>
                        </tr>
                    </table>
