...
function setValues_Item() {
  ...
  gridnms["grid.4"] = "ItemMaterialList";
  gridnms["grid.5"] = "uomLov";
  gridnms["grid.6"] = "customerLov";
  gridnms["grid.7"] = "itemtypeLov";
  gridnms["grid.8"] = "itemclassLov";
  gridnms["grid.9"] = "subitemLov";
      ...
      editor: {
        ...
        listeners: {
          select: function (value, record, eOpts) {
            ...
            model.set("ITEMCLASS", record.data.VALUE);
          },
      ...
      editor: {
        ...
        listeners: {
          select: function (value, record, eOpts) {
            ...
            model.set("SUBITEM", record.data.VALUE);
          },
          change: function (value, nv, ov, eOpts) {
            var model = Ext.getStore(gridnms["store.4"]).getById(Ext.getCmp(gridnms["views.item"]).selModel.getSelection()[0].id);
...
function btnAdd4Click(o, e) {
  ...
  model.set("SUBITEM", "20");
  model.set("SUBITEMNAME", "도급");
...
function fn_excel_download() {
  ...
  go_url("<c:url value='/item/mat/ExcelDownload.do?ORGID='/>" + orgid + ""
     + "&COMPANYID=" + companyid + ""
     + "&ITEMCODE=" + itemcode + ""
     + "&GROUPCODE=" + "${searchVO.GROUPCODE}" + ""
     + "&TITLE=" + title + "");
