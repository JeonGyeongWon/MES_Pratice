                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a class="btn_search" href="#noscript" onclick="fn_egov_search_Zip(); return false;">조회</a>
                                        <a class="btn_create" href="#noscript" onclick="fn_egov_regist_Zip(); return false;">등록</a>
                                        <a class="btn_print" href="#noscript" onclick="fn_egov_regist_ExcelZip(); return false;">엑셀등록</a> 
                                    </div>                              
                                </li>
                            </ul>           
                        </div>          
