            ...
            <div id="content">
				       ...
				       <form name="listForm" action="<c:url value='/uss/umt/user/EgovUserManage.do'/>" method="post">
                        ...
                        <div class="sf_start">
                            <ul id="search_first_ul">
                                <li>
                                	<input type="hidden" name ="sbscrbSttus" value="P" />
					                ...
					                <select name="searchCondition" id="searchCondition" title="검색조건2-검색어구분">
					                    ...
					                    <option value="1" <c:if test="${empty userSearchVO.searchCondition || userSearchVO.searchCondition == '1'}">selected="selected"</c:if> >거래처명</option>
					                </select>
                                </li>
                                <li>
                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a class="btn_search" href="<c:url value='/uss/umt/user/EgovUserManage.do'/>" onclick="javascript:fnSearch(); return false;">조회 </a>
				                        <a class="btn_delete" href="#LINK" onclick="javascript:fnDeleteUser(); return false;"><spring:message code="button.delete" /></a>
				                        <a class="btn_list" href="<c:url value='/uss/umt/user/EgovUserManage.do'/>"><spring:message code="button.list" /></a>
				                        <a class="btn_create" href="<c:url value='/uss/umt/user/EgovUserInsertView.do'/>" onclick="fnAddUserView(); return false;"><spring:message code="button.create" /></a>
                                    </div>                              
                                </li>
                            </ul>           
                        </div>          
                ...
                <div class="default_tablestyle">
                    ...
                    <tr>
                        ...
                        <th scope="col" nowrap="nowrap">거래처명</th>
                    ...
                    <!-- loop 시작 -->                                
                      <tr>
	                    ...
	                    <td nowrap="nowrap"><c:out value="${result.offmTelno}"/></td>
