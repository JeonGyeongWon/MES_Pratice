...
<div id="skipNav" class="invisible">
	<dl>
		<dt>콘텐츠 바로가기</dt>
		<dd>
			<a href="#middle_content">컨텐츠 바로가기</a>
		</dd>
		<dd>
			<a href="#topmenu_nav">메인메뉴 바로가기</a>
		</dd>
		<dd>
			<a href="#leftmenu_div">좌메뉴 바로가기</a>
		</dd>
	</dl>
</div>
<div class="login_area_loc">
	...
	<div class="loginbg02">
		...
		<ul>
			...
			<li>|</li>
			<li><a href="javascript:Logout()">로그오프</a></li>
		</ul>
		<%
			}
		%>
...
<h1>
	<a href="<c:url value='/'/>cmm/main/mainPage.do">템플릿 로고</a>
...
<div id="SubTopSearch">
	<form action="#LINK" name="SubTopSearchForm" id="SubTopSearchForm" method="post">
		<select id="subsearch" name="subsearch">
			...
			<option value=""></option>
		</select> <input type="text" class="inputText" name="search" id="search">&nbsp;
...
<form name="menuListForm" action="/sym/mnu/mpm/EgovMenuListSelect.do" method="post">
	<input type="hidden" id="menuNo" name="menuNo" value="<%=session.getAttribute("menuNo")%>" /> <input type="hidden" id="link" name="link" value="" />
