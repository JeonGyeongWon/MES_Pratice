...
google.charts.load('current', {
	...
	var status_data;
	// var header_g;
	var header_g = [' ', '필요 제조리드타임', '실 제조리드타임'];
	...
	function drawVisualization() {
	  ...
	  var url_x = '<c:url value="/select/manage/kpi/ManageKpi5List1.do" />';
	  ...
	  $.ajax({
	    ...
	    success: function (data) {
	      ...
	      for (var i = 0; i < charcount; i++) {
	        ...
	        row_g = [list.TRXMONTHS + "월", list.NEEDLEADTIME, list.REALLEADTIME];
	...
	function drawCharter() {
	  ...
	  var url_x = '<c:url value="/select/manage/kpi/ManageKpi5List2.do" />';
	    ...
	    success: function (data) {
	      ...
	      for (var j = 0; j < charcount; j++) {
	        ...
	        for (l = 0; l < date_temp.length; l++) {
	          if (date_temp[l] == list.TRXMONTHS) {
	            c_count++;
	          }
	        }
	        if (c_count == 0) {
	          date_temp.push(list.TRXMONTHS);
	        }
	      }
	      date_temp.sort();
...
// 	      align: "left",
	  ...
	  items["api.1"] = {};
	  $.extend(items["api.1"], {
	    read: "<c:url value='/select/manage/kpi/ManageKpi5List3.do' />"
	  });
...
// 	    ITEMCODE: $('#searchItemcd').val(),
	  ...
	  url = "<c:url value='/select/manage/kpi/ManageKpi5List2.do' />";
	...
	function fn_search_y() {
	  ...
	  url = "<c:url value='/select/manage/kpi/ManageKpi5List1.do' />";
...
<!--                    &nbsp;~&nbsp; -->
                ...
                <div id="chart_div" style="width: 100%; height: 30%"></div>
                    ...
                    <td><input type="text" id="searchOrdernm" name="searchOrdernm" class="input_center" style="width: 150px"; /></td>
										...
										<td><input type="text" id="searchItemnm" name="searchItemnm" class="input_center" style="width: 150px"; />
                    <input type="hidden" id="searchItemcd" name="searchItemcd" /></td>
