...
<noscript>자바스크립트를 지원하지 않는 브라우저에서는 일부 기능을 사용하실 수 없습니다.</noscript>
				...
				<div>
								<form name="menuCreatManageForm" action="/sym/mpm/EgovMenuCreatSiteMapSelect.do" method="post">
												<input type="submit" id="invisible" class="invisible" /> <input name="checkedMenuNoForInsert" type="hidden"> <input name="checkedAuthorForInsert" type="hidden">
																...
																<fieldset>
																				...
																				<div class="sf_start">
																								<ul id="search_first_ul">
																												<li><label for="search_select">권한코드 : </label> <input name="authorCode" type="text" size="30" maxlength="30" title="권한코드" value="${resultVO.authorCode}" readonly>
																												<li>
																								</ul>
