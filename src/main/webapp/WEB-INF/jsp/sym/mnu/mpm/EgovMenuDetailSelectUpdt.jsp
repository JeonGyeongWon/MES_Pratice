            ...
            <div id="content">
                ...
                <form:form commandName="menuManageVO" name="menuManageVO" action ="<c:url value='/sym/mnu/mpm/EgovMenuDetailSelectUpdt.do' />" method="post">
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <tr> 
                          <td>
                            <a class="btn_list" href="<c:url value='/sym/mnu/mpm/EgovMenuManageSelect.do'/>" onclick="selectList(); return false;">목록</a> 
                          </td>
<!--                           <td width="10"></td> -->
                          <td>
                            <a class="btn_save" href="#LINK" onclick="javascript:updateMenuManage(document.getElementById('menuManageVO')); return false;"><spring:message code="button.save" /></a> 
                          </td>
<!--                           <td width="10"></td> -->
                          <td>
                            <a class="btn_delete" href="#LINK" onclick="deleteMenuManage(document.getElementById('menuManageVO')); return false;"><spring:message code="button.delete" /></a> 
                          </td>
                        </tr>
                        </table>
                    </div>
