            ...
            <div id="content">
                ...
                <form:form commandName="progrmManageVO"  action="/sym/prm/EgovProgramListRegist.do" method="post" >
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <tr> 
                          <td>
                            <a class="btn_list" href="<c:url value='/sym/prm/EgovProgramListManageSelect.do'/>" onclick="selectList(); return false;"><spring:message code="button.list" /></a> 
                          </td>
<!--                           <td width="10"></td> -->
                          <td>
                            <a class="btn_save" href="#LINK" onclick="javascript:insertProgramListManage(document.getElementById('progrmManageVO')); return false;"><spring:message code="button.save" /></a> 
                          </td>
                        </tr>
                        </table>
                    </div>
