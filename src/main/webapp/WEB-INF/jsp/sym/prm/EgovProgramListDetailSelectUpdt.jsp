            ...
            <div id="content">
                ...
                <form:form commandName="progrmManageVO" action="/sym/prm/EgovProgramListDetailSelectUpdt.do">
                    ...
                    <div class="modify_user" >
                        <table summary="프로그램목록 상세조회 /수정">
						  ...
						  <tr> 
						    ...
						    <img src="${ImgUrl}/required.gif" width="15" height="15" alt="필수"></th>
						    <td width="80%" nowrap="nowrap">
						      <form:input path="URL" size="60"  maxlength="80" title="URL" />
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <tr> 
                          <td>
                            <a class="btn_list" href="<c:url value='/sym/mpm/EgovProgramListManageSelect.do'/>" onclick="selectList(); return false;">목록</a> 
                          </td>
<!--                           <td width="10"></td> -->
                          <td>
                            <a class="btn_save" href="#LINK" onclick="javascript:updateProgramListManage(document.getElementById('progrmManageVO')); return false;"><spring:message code="button.save" /></a> 
                          </td>
<!--                           <td width="10"></td> -->
                          <td>
                            <a class="btn_delete" href="<c:url value='/sym/prm/EgovProgramListManageDelete.do'/>?progrmFileNm=<c:out value="${progrmManageVO.progrmFileNm  }"/>" onclick="deleteProgramListManage(document.getElementById('progrmManageVO')); return false;"><spring:message code="button.delete" /></a> 
                          </td>
                        </tr>
                        </table>
                    </div>
