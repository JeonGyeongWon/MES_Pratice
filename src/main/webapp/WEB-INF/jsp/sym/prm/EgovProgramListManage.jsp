                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a class="btn_search" href="#LINK" onclick="javascript:selectProgramListManage(); return false;" >조회</a>
                                        <a class="btn_create" href="<c:url value='/sym/mpm/EgovProgramListRegist.do'/>" onclick="insertProgramListManage(); return false;"><spring:message code="button.create" /></a>                              
                                        <a class="btn_delete" href="#LINK" onclick="fDeleteProgrmManageList(); return false;"><spring:message code="button.delete" /></a>
                                    </div>
                                </li>
                            </ul>           
                        </div>          
