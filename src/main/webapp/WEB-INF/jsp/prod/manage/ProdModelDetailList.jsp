...
$(document).ready(function () {
	...
	function setInitial() {
	  ...
	  var searchmonth = "${searchVO.searchMonth}";
	  if (searchmonth != "") {
	...
	function setValues(yyyymm) {
	  ...
	  gridnms["grid.1"] = "ProdModelDetailList";
	  ...
	  items["api.1"] = {};
	  $.extend(items["api.1"], {
	    read: "<c:url value='/select/prod/manage/ProdModelDetailList.do' />"
	  });
                            ...
                            <div>
                                ...
                                <table class="tbl_type_view" border="1">
                                    ...
                                    <tr style="height: 34px;">
                                        ...
                                        <td>
                                              <input type="text" id="searchItemName" name="searchItemName"  class="input_validation input_left" onKeyUp="javascript:this.value=this.value.toUpperCase();" oncontextmenu="return false" style="width: 94%;" value="${searchVO.itemname}" />
                                        </td>
                                        <th class="required_text">기종</th>
                                        <td >
                                            <input type="text" id="searchModelName" name="searchModelName"  class="input_left" onKeyUp="javascript:this.value=this.value.toUpperCase();" oncontextmenu="return false" style="width: 97%;" value="${searchVO.cartypename}" />
                                            <input type="hidden" id="searchModelCode" name="searchModelCode" value="${searchVO.cartype}" />
                                        </td>
