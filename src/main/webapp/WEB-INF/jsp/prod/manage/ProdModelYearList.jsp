...
$(document).ready(function () {
	...
	function setInitial() {
	  $('#searchYear').keyup(function (event) {
	    if (event.keyCode != '8') {
	      var v = this.value;
	      if (v.length === 4) {
	        this.value = v + "-";
	  ...
	  $("#searchYear").val(getToDay("${searchVO.TODAY}") + "");
	...
	function setValues() {
	  ...
	  items["api.1"] = {};
	  $.extend(items["api.1"], {
	    read: "<c:url value='/select/prod/manage/ProdModelYearList.do' />"
	  });
                            ...
                            <div>
                                ...
                                <table class="tbl_type_view" border="1">
                                    ...
                                    <tr style="height: 34px;">
                                        ...
                                        <td>
                                          <input type="text" id="searchYear" name="searchYear" class="input_validation input_center" style="width: 100px; min-width: 100px;" maxlength="4" value="${searchVO.TODAY}" />
                                        </td>
