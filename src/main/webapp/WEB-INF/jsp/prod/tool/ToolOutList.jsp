...
$(document).ready(function () {
	...
	function setValues_master() {
	  ...
	  fields["columns.1"] = [
	    // Display Columns
	    {
	      ...
	      renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
	        ...
	        var url = "<c:url value='/prod/tool/ToolOutManage.do?no=' />" + record.data.OUTNO + "&org=" + record.data.ORGID + "&company=" + record.data.COMPANYID;
	  ...
	  items["api.1"] = {};
	  $.extend(items["api.1"], {
	    read: "<c:url value='/select/prod/tool/ToolOutList.do' />"
	  });
	...
	function setLovList() {
	  // 반출번호 Lov
	  $("#searchOutNo").bind("keydown", function (e) {
	    switch (e.keyCode) {
	    case $.ui.keyCode.TAB:
	    ...
	    source: function (request, response) {
	      $.getJSON("<c:url value='/select/prod/tool/ToolOutList.do' />", {
                            ...
                            <div>
                                ...
                                <table class="tbl_type_view" border="1">
                                    ...
                                    <tr style="height: 34px;">
                                        ...
                                        <td>
                                            <input type="text" id="searchOutNo" name="searchOutNo" class="input_left"  style="width: 97%;" />
                                        </td>        
                                    ...
                                    <tr style="height: 34px;">
                                        ...
                                        <td>
                                            <select id="searchOutStatus" name="searchOutStatus" class="input_left validate[required]" style="width: 97%;">
