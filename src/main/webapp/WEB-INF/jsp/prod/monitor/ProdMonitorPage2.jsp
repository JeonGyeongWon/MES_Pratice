...
function setValues_monitoring() {
  ...
  gridnms["grid.1"] = "ProdMonitorPage2";
  ...
  fields["columns.1"] = [{
      ...
      align: "center",
      renderer: function (value, meta, record) {
        var prodcolor = record.data.PRODCOLOR;
        meta.style = "background-color:" + prodcolor + ";";
  ...
  items["api.1"] = {};
  $.extend(items["api.1"], {
    read: "<c:url value='/select/prod/monitor/ProdMonitorPage2.do' />"
  });
...
function setExtGrid_monitoring() {
  ...
  Ext.define(gridnms["controller.1"], {
    ...
    refs: {
      MonitorPage2List: '#MonitorPage2List',
    },
...
setInterval(function () {
  ...
  if (currentpage == lastpage) {
    go_url('<c:url value="/prod/monitor/ProdMonitorPage3.do" />');
  } else {
    currentpage += 1;
