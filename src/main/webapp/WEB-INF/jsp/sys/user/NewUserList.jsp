...
$(document).ready(function () {
	...
	function setValues() {
	    ...
	    // Display columns
	    {
	      ...
	      align: "center",
	        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
	            ...
	            var url = "<c:url value='/sys/user/NewUserManage.do?code=' />" + record.data.USERID;
	  ...
	  items["api.1"] = {};
	  $.extend(items["api.1"], {
	    read: "<c:url value='/select/sys/user/NewUserList.do' />"
	  });
	    ...
	    constructor: function (cfg) {
	      ...
	      me.callParent([Ext.apply({
	            ...
	            proxy: {
	              ...
	              api: items["api.1"],
	              extraParams: {
	            	  GUBUN: $('#searchKeywordOption option:selected').val(),
	              },
	...
	function fn_search() {
	  ...
	  var keywordoption = $('#searchKeywordOption').val();
	...
	function fn_regist(master) {
	  ...
	  var url = '<c:url value="/sys/user/NewUserManage.do" />';
                            ...
                            <fieldset>
                                ...
                                <table class="tbl_type_view" border="1">
                                    ...
                                    <tr style="height: 34px;">
                                        <td colspan="3">
                                            <div class="buttons" style="float: right; margin-top: 3px;">
                                                ...
                                                <a id="btnChk2" class="btn_add" href="#" onclick="javascript:fn_regist('master');"> 추가 </a>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                    <table class="tbl_type_view" border="1">
                                        ...
                                        <tr style="height: 34px;">
                                            <th class="required_text">검색조건</th>
                                            <td>
                                                <select type="text" id="searchKeywordOption" name="searchKeywordOption" class="input_left input_validation" style="width: 97%;" >
                                                    <option value="ID">아이디</option>
                                                    <option value="NAME" selected>사용자명</option>
                                                </select>
                                            </td>
                                            <th class="required_text">입력항목</th>
                                            <td>
                                                <input type="text" id="searchKeyword" name="searchKeyword" class="input_left" style="width: 97%;" />
                                            </td>
                                            <td></td>
                                            <td></td>
                                        </tr>
