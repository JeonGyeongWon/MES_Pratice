...
function setValues(yyyymm) {
    ...
    items["api.1"] = {};
    $.extend(items["api.1"], {
        read: "<c:url value='/select/scm/outprocess/ScmOutTransModelList.do' />"
    });
...
function fn_search() {
    ...
    var searchItemName = $("#searchItemName").val();
    var cartype = $('#searchModelName').val();
                            ...
                            <div>
                                ...
                                <table class="tbl_type_view" border="1">
                                    ...
                                    <tr style="height: 34px;">
                                        ...
                                        <td>
                                          <input type="text" id="searchMonth" name="searchMonth" class="input_validation input_center" style="width: 97%; min-width: 100px;" maxlength="7" value="${searchVO.TODAY}" />
                                        </td>
                                        ...
                                        <td>
                                              <input type="text" id="searchRoutingName" name="searchRoutingName" class="imetype input_center" onKeyUp="javascript:this.value=this.value.toUpperCase();" oncontextmenu="return false" style="width: 97%;"/>
                                        </td>
