...
function setValues_Inventory() {
    ...
    gridnms["grid.1"] = "ProdInventoryList";
    ...
    fields["columns.1"] = [
        // Display Columns
        {
            ...
            //      }, {
            //        dataIndex: 'PRESENTINVENTORYPRICE',
            //        text: '재고금액',
            //        xtype: 'gridcolumn',
            //        width: 95,
            //        hidden: false,
    ...
    items["api.1"] = {};
    $.extend(items["api.1"], {
        read: "<c:url value='/select/order/prod/ProdInventoryList.do' />"
    });
...
function fn_excel_download() {
    ...
    var searchItemName = $("#searchItemName").val();
    var searchModelName = $("#searchModelName").val();
    go_url("<c:url value='/order/prod/ExcelDownload.do?GUBUN='/>" + "INVENTORY"
         + "&ORGID=" + orgid + ""
         + "&COMPANYID=" + companyid + ""
         + "&TRXDATE=" + searchMonth + ""
         + "&ITEMCODE=" + searchItemCode + ""
                            ...
                            <input type="hidden" id="searchItemCode" name="searchItemCode" />
                                ...
                                <table class="tbl_type_view" border="1">
                                    ...
                                    <tr style="height: 34px;">
                                        ...
                                        <td>
                                          <input type="text" id="searchMonth" name="searchMonth" class="input_validation input_center" style="width: 98%; min-width: 100px;" maxlength="7" value="${searchVO.TODAY}" />
                                        </td>
