...
function setValues(yyyymm) {
    ...
    items["api.1"] = {};
    $.extend(items["api.1"], {
        read: "<c:url value='/select/order/ship/ShipModelList.do' />"
    });
...
function fn_next_page(rownum) {
    ...
    var column = 'master';
    var url = "<c:url value='/order/ship/ShipModelDetailList.do'/>";
    var target = '_self';
...
function fn_search() {
    ...
    var cartype = $('#searchModelName').val(); //기종
    var itemcode = $('#searchOrdernm').val(); //품번
    var itemname = $('#searchItemName').val(); //품명
    var type = $('#searchTypeName').val(); //타입
                                ...
                                <table class="tbl_type_view" border="1">
                                    ...
                                    <tr style="height: 34px;">
                                        ...
                                        <th class="required_text">품번</th>
			                                  <td>
			                                        <input type="text" id="searchOrdernm" name="searchOrdernm" class="input_center" onKeyUp="javascript:this.value=this.value.toUpperCase();" style="width: 94%;" />
			                                        <input type="hidden" id="searchItemcd" name="searchItemcd" />
			                                  </td>
                                         <th class="required_text">품명</th>
                                        <td>
                                              <input type="text" id="searchItemName" name="searchItemName"  class="input_center" onKeyUp="javascript:this.value=this.value.toUpperCase();" oncontextmenu="return false" style="width: 94%;"/>
                                        </td>
                                        <th class="required_text">기종</th>
                                        <td >
                                            <input type="text" id="searchModelName" name="searchModelName"  class="input_left" onKeyUp="javascript:this.value=this.value.toUpperCase();" oncontextmenu="return false" style="width: 94%;" />
                                            <input type="hidden" id="searchModelCode" name="searchModelCode" />
                                        </td>
                                        <th class="required_text">타입</th>
                                        <td><input type="text" id="searchTypeName" name="searchTypeName"  class="input_left" onKeyUp="javascript:this.value=this.value.toUpperCase();" oncontextmenu="return false" style="width: 94%;" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
