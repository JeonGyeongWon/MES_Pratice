...
function setValues_master() {
    ...
    fields["columns.1"] = [
        // Display columns
        {
            ...
            renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                ...
                var url = "<c:url value='/order/manage/OrderManageRegist.do?SONO=' />" + record.data.SONO + "&org=" + record.data.ORGID + "&company=" + record.data.COMPANYID;
    ...
    items["api.1"] = {};
    $.extend(items["api.1"], {
        read: "<c:url value='/select/order/manage/OrderManageStateListMaster.do' />"
    });
...
function setValues_detail() {
    ...
    gridnms["grid.2"] = "OrderManageRegistDetail";
...
function fn_save() {
	...
	//외주 거래처에 한해서 특정값을 넘겨줌 
	if(authCode == "ROLE_SCM_R"){
		go_url("<c:url value='/order/manage/OrderManageRegist.do?auth=Y' />");
	}else{
...
function fn_excel_upload() {
    ...
    document.excelform.action = "<c:url value='/order/manage/ExcelUpload.do'/>";
    document.excelform.submit();
}

function fn_excel_sample() {
    go_url("<c:url value='/uploadfiles/excel/template/SalesUploadSample.xlsx' />");
}
...
function setLovList() {
    ...
    $("#SoNo").bind("keydown", function (e) {
        ...
        source: function (request, response) {
            $.getJSON("<c:url value='/searchSoNoFindLovList.do' />", {
                keyword: extractLast(request.term),
                ORGID: $('#searchOrgId option:selected').val(),
                COMPANYID: $('#searchCompanyId option:selected').val(),
                GUBUN: 'SONO',
                    ...
                    <fieldset>
                        ...
                        <table class="tbl_type_view" border="1">
                            ...
                            <tr style="height: 34px;">
                                ...
                                <td>
                                    <input type="text" id="SoNo" name="SoNo" class="imetype input_center" onKeyUp="javascript:this.value=this.value.toUpperCase();" oncontextmenu="return false" style="width: 94%;"/>
                                </td>
                            ...
                            <tr style="height: 34px;">
                                ...
                                <td><select id="SoStatus" name="SoStatus" class="input_left " style="width: 94%;">
