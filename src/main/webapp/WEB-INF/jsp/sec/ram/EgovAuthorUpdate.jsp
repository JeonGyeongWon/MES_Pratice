            ...
            <div id="content">
                ...
                <form:form commandName="authorManage" method="post" >
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <tr> 
                          <td>
                            <a class="btn_list" href="#LINK" onclick="javascript:fncSelectAuthorList()" style="selector-dummy:expression(this.hideFocus=false);">목록</a> 
                          </td>
                          <c:if test="${registerFlag == 'INSERT'}">
<!-- 	                          <td width="10"></td> -->
	                          <td>
	                            <a class="btn_save" href="#LINK" onclick="javascript:fncAuthorInsert()" style="selector-dummy:expression(this.hideFocus=false);">저장</a> 
	                          </td>
					      </c:if>
					      <c:if test="${registerFlag == 'UPDATE'}">
<!-- 	                          <td width="10"></td> -->
	                          <td>
	                            <a class="btn_save" href="#LINK" onclick="javascript:fncAuthorUpdate()" style="selector-dummy:expression(this.hideFocus=false);">저장</a> 
	                          </td>
<!-- 	                          <td width="10"></td> -->
	                          <td>
	                            <a class="btn_delete" href="#LINK" onclick="javascript:fncAuthorDelete()" style="selector-dummy:expression(this.hideFocus=false);">삭제</a> 
	                          </td>
					      </c:if>
                        </tr>
                        </table>
