                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float: right; margin-top: 3px;">
                                        <a class="btn_search" href="#LINK" onclick="javascript:fncSelectAuthorList('1')" style="selector-dummy:expression(this.hideFocus=false);">조회 </a>
                                        <a class="btn_create" href="#LINK" onclick="javascript:fncAddAuthorInsert()" style="selector-dummy:expression(this.hideFocus=false);">등록</a>
                                        <a class="btn_delete" href="#LINK" onclick="javascript:fncAuthorDeleteList()" style="selector-dummy:expression(this.hideFocus=false);">삭제</a>
                                    </div>                              
                                </li>
                            </ul>           
                        </div>          
