                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a class="btn_search" href="#LINK" onclick="javascript:fncSelectGroupList('1')" style="selector-dummy:expression(this.hideFocus=false);">조회</a>
                                        <a class="btn_create" href="#LINK" onclick="javascript:fncAddGroupInsert()" style="selector-dummy:expression(this.hideFocus=false);">등록</a> 
                                        <a class="btn_delete" href="#LINK" onclick="javascript:fncGroupListDelete()" style="selector-dummy:expression(this.hideFocus=false);">삭제</a>
                                    </div>                              
                                </li>
                            </ul>           
                        </div>          
                ...
                <div class="default_tablestyle">
                    ...
                    <!-- loop 시작 -->                                
                      <tr>
					    ...
					    <td nowrap="nowrap"><a href="#LINK" onclick="javascript:fncSelectGroup('<c:out value="${group.groupId}"/>')">${group.groupId}</a></td>
