...
<%--   <tr>
    <th width="20%" height="23" class="required_text" nowrap >일정구분1<img src="<c:url value='/'/>images/required.gif" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%" >
        <form:select path="schdulSe1">
            <form:option value="" label="선택"/>
            <form:options items="${schdulSe1}" itemValue="code" itemLabel="codeNm"/>
        </form:select>
        <div><form:errors path="schdulSe1" cssClass="error"/></div>
    </td>
  </tr> --%>
  <tr>
