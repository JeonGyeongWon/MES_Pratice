...
<%--   <td><span class="button"><a href="JavaScript:fn_egov_delete_IndvdlSchdulManage();">
  ...
  <td><span class="button"><input type="submit" value="<spring:message code="button.delete" />" title="<spring:message code="button.delete" />" onclick="JavaScript:fn_egov_delete_IndvdlSchdulManage();return false;"></span></td>
...
<%-- 	<c:if test="${useDiaryManage == 'true'}">
	  ...
	  <td><span class="button"><input type="submit" value="일지관리" title="<spring:message code="button.inquire" />" onclick="JavaScript:fn_egov_diary_IndvdlSchdulManage();return false;"></span></td>  
	</c:if> --%>
	<!-- 2011.09.16 끝  -->
...
<%--   <td><span class="button"><a href="JavaScript:fn_egov_modify_IndvdlSchdulManage();">
  ...
  <td><span class="button"><input type="submit" value="<spring:message code="button.update" />" title="<spring:message code="button.update" />" onclick="JavaScript:fn_egov_modify_IndvdlSchdulManage();return false;"></span></td>  
</tr>
</table>
</center>
