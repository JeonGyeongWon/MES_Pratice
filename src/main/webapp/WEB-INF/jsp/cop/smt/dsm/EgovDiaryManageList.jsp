...
<table width="100%" cellpadding="1" class="table-search" border="0">
 <tr>
  <td class="title_left">
	<h1>
  		<img src="<c:url value='/images/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;일지관리 목록
  	</h1>
  </td>
  <th>
  </th>
  ...
  <th width="70px" align="center">
   <table border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      ...
      <td>&nbsp;</td>
      <td><img src="<c:url value='/images/bu2_left.gif'/>" width="8" height="20" alt="버튼이미지"></td>
      ...
      <td><img src="<c:url value='/images/bu2_right.gif'/>" width="8" height="20" alt="버튼이미지"></td>
    </tr>
   </table>
  </th>
 </tr>
