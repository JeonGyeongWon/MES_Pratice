...
<c:set var="ImgUrl" value="/images/egovframework/let/cop/smt/dsm/"/>
<c:set var="CssUrl" value="/css/egovframework/let/cop/smt/dsm/"/>
...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/images/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;일지관리 등록</td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >일정정보<img src="<c:url value='/images/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%">
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tr>
			...
			<a href="#" onClick="fn_egov_Schdule_DiaryManage()">
				<img src="<c:url value='/images/search.gif'/>"  align="middle" style="border:0px" alt="일정정보" title="일정정보">
			</a>
			</td>
		</tr>
		</table>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >일지명<img src="<c:url value='/images/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >지시사항<img src="<c:url value='/images/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%">
        <form:textarea path="drctMatter" rows="3" cols="71" cssClass="txaClass"/>
    	<div><form:errors path="drctMatter" cssClass="error"/></div>
    </td>
  </tr>

  <tr>
    <th width="20%" height="23" class="required_text" nowrap >특이사항<img src="<c:url value='/images/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%">
        <form:textarea path="partclrMatter" rows="3" cols="71" cssClass="txaClass"/>
    	<div><form:errors path="partclrMatter" cssClass="error"/></div>
    </td>
  </tr>

  <tr>
    <th width="20%" height="23" class="required_text" nowrap >진척율<img src="<c:url value='/images/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%">
