...
<c:set var="ImgUrl" value="/images/egovframework/let/cop/smt/sdm/"/>
<c:set var="CssUrl" value="/css/egovframework/let/cop/smt/sdm/"/>
...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do'/>";	
