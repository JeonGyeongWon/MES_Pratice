                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a class="btn_search" href="#noscript" onclick="fn_egov_select_noticeList('1'); return false;">조회 </a>
                                        <c:if test="${brdMstrVO.authFlag == 'Y'}">
                                            <a class="btn_create" href="<c:url value='/cop/bbs${prefix}/addBoardArticle.do'/>?bbsId=<c:out value="${boardVO.bbsId}"/>">등록</a>
                                        </c:if>
                                    </div>                              
                                </li>
                            </ul>           
