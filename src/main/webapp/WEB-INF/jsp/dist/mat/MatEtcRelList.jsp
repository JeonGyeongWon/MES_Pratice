...
function setValues_master() {
    ...
    gridnms["grid.1"] = "MatEtcRelListMaster";
    ...
    fields["columns.1"] = [
        // Display Columns
        {
            ...
            renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                ...
                var url = "<c:url value='/dist/mat/MatEtcRelManage.do?relno=' />" + record.get("RELEASENO") + "&org=" + record.get("ORGID") + "&company=" + record.get("COMPANYID");
