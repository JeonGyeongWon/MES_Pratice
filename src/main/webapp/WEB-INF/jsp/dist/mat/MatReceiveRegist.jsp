...
function setValues_master() {
    ...
    fields["columns.1"] = [
        // Display Columns
        {
            ...
            renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                ...
                var url = "<c:url value='/dist/mat/ReceiveRegistD.do?no=' />" + record.data.TRANSNO + "&org=" + record.data.ORGID + "&company=" + record.data.COMPANYID;
    ...
    items["api.1"] = {};
    $.extend(items["api.1"], {
        read: "<c:url value='/select/dist/mat/MatTransMasterList.do' />"
    });
...
function onMasterClick(dataview, record, item, index, e, eOpts) {
    ...
    var transno = record.data.TRANSNO;
...
function setExtGrid_master() {
    ...
    Ext.define(gridnms["controller.1"], {
        ...
        refs: {
            TransMasterList: '#TransMasterList',
        },
...
function fn_search() {
    ...
    var transfrom = $('#searchFrom').val();
    var transto = $('#searchTo').val();
    var header = [],
    count = 0;
...
function setLovList() {
    ...
    // 사급처명 Lov
    $("#searchCustomerNameS").bind("keydown", function (e) {
        switch (e.keyCode) {
        case $.ui.keyCode.TAB:
            if ($(this).autocomplete("instance").menu.active) {
                e.preventDefault();
        ...
        case $.ui.keyCode.BACKSPACE:
        case $.ui.keyCode.DELETE:
            //             $("#searchCustomerNameS").val("");
            $("#searchCustomerCodeS").val("");
            break;
        case $.ui.keyCode.ENTER:
            $(this).autocomplete("search", "%");
            break;
        ...
        select: function (e, o) {
            $("#searchCustomerCodeS").val(o.item.value);
            $("#searchCustomerNameS").val(o.item.NAME);
		            ...
		            <div id="search_field">
                        ...
                        <table class="tbl_type_view" border="1">
                            ...
                            <tr style="height: 34px;">
                                ...
                                <td>
                                    <input type="text" id="searchCustomerName" name="searchCustomerName" class="input_left"  onKeyUp="javascript:this.value=this.value.toUpperCase();" oncontextmenu="return false" style="width: 97%;" />
                                </td>
                            ...
                            <tr style="height: 34px;">
                                ...
                                <td>
                                    <input type="text" id="searchCustomerNameS" name="searchCustomerNameS" class="input_left"  onKeyUp="javascript:this.value=this.value.toUpperCase();" oncontextmenu="return false" style="width: 97%;" />
                                </td>
                                <th class="required_text">유무상구분</th>
                                <td>
                                    <select id="searchPaidYn" name="searchPaidYn" class="input_left " style="width: 97%;">
                                    </select>
                                </td>
                            </tr>
                        </table>
