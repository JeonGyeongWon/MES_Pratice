...
window.ActiveXObject && !window.CanvasRenderingContext2D && function () {
	...
	w.prototype = {
		...
		drawImage : function (a, b, c, d, f, g, j, M, N) {
			...
			if (3 === l)
				...
				(0 === d || 0 === f) && i(1), this._queue.push(e.drawImage, l, k, b, c, d, f, g, j, M, N);
			else
				return;
				...
				for (B in d)
					if (b = d[B], c = b.firstChild, k = b.ownerDocument.defaultView ? b.ownerDocument.defaultView : b.ownerDocument.parentWindow, a === k) {
						...
						for (l = e[B].length; k !== l; k++)
							j = e[B][k], c.detachEvent(j[0], j[1]), b.detachEvent(j[0], j[1])
					}
	...
	m.unlock = function (a, b, c) {
		try {
			...
			l;
			if (void 0 === b)
				d = this.canvases[a], e = d.firstChild, k = d.ownerDocument, l = k.defaultView ? k.defaultView : k.parentWindow, F(d), g = d.width, j = d.height, d.style.width = g + "px", d.style.height = j + "px", 0 < g && (e.width = g), 0 < j && (e.height = j), e.resize(g, j), b = function (a) {
					var a = a ? a : l.event,
					b = a.propertyName;
					if ("width" === b || "height" === b) {
						var a = a.srcElement,
			...
			"function" === typeof d.onload && l.setTimeout(function () {
				...
				m = i[0], h = i[1 + c], delete x[a][b], "function" === typeof h && h.call(m);
			q[a] && --q[a]
		} catch (n) {
