...
(function ($) {
	...
	(function () {
		...
		function r(b, j, a) {
			...
			if ("ratio" === b || "%" === b.split("")[b.length - 1])
				this.eventTokens[w + ".parentresized"] = c.subscribe(w + ".parentresized",
						function (b, j, a) {
						return function () {
							var g = j.width();
							if (g !== a) {
			...
			this.events.subscribe("jSignature.attachingEventHandlers", function () {
				if (this.settings[q]) {
					...
					"function" !== typeof m && (m = function () {
						var e = $('<input type="button" value="되돌리기" style="position:absolute;display:none;margin:0 !important;top:auto" />').appendTo(this.$controlbarLower),
						k = e.width();
	...
	(function () {
		...
		v = function (e) {
			for (var h =
					[], e = e.split(""), a = e.length, f, d = 1, c = [], l = 0, i = 0; i < a; i++)
