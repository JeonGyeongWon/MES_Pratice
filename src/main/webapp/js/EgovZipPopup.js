...
function find_vendor(frm, searchVendorSiteId, searchVendorSiteName ) {
	var retVal;

	var url = "/uss/umt/user/EgovUserManage.do?flag=POP2"; 
	var varParam = new Object();
	varParam.sZip = "";		
	...
	if(retVal) {
		searchVendorSiteId.value = retVal.vendor_id;
		searchVendorSiteName.value = retVal.vendor_nm;
	}
}



function fn_FindUser(frm, sZip, vZip, sAddr) {
	var retVal;
