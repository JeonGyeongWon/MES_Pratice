...
public class EgovMainController {
	...
	public String getMgtMainPage(HttpServletRequest request, ModelMap model, @RequestParam HashMap<String, Object> requestMap)
	  throws Exception{
		System.out.println("getMgtMainPage Start. >>>>>>>>>> " + requestMap);
...
//        }
		...
		// 2016.12.28 로그인 권한별 메뉴 번호 갱신
		try {
			String menuno = StringUtil.nullConvert(requestMap.get("menuno"));
			if ( !menuno.isEmpty() ) {
