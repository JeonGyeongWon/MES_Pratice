...
import org.springframework.security.intercept.web.EgovReloadableDefaultFilterInvocationDefinitionSource;
...
*/    
	...
	public String insertRole(@ModelAttribute("roleManage") RoleManage roleManage,
    	...
    	if (bindingResult.hasErrors()) { 
	       ...
	       // ((EgovReloadableDefaultFilterInvocationDefinitionSource) filterSecurityInterceptor.getObjectDefinitionSource()).reloadRequestMap();
	        return "/sec/rmt/EgovRoleUpdate";
		}
	}
