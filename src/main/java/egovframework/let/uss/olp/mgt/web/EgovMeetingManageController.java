package egovframework.let.uss.olp.mgt.web;
...
import egovframework.let.uss.olp.mgt.service.EgovMeetingManageService;
import egovframework.let.uss.olp.mgt.service.MeetingManageVO;
...
public class EgovMeetingManageController {
    ...
    public String egovMeetingManageMain(ModelMap model) throws Exception {
    	...
    	return "uss/olp/mgt/EgovMeetingManageMain";
    }
    ...
    public String egovMeetingManageLeft(ModelMap model) throws Exception {
    	...
    	return "uss/olp/mgt/EgovMeetingManageLeft";
    }
    ...
    throws Exception {
    	...
    	/*return "egovframework/com/uss/olp/mgt/EgovMeetingManageLisAuthorGroupPopup";*/
         return "uss/olp/mgt/EgovMeetingManageLisAuthorGroupPopup";
    }
    ...
    throws Exception {
		...
		/*return "egovframework/com/uss/olp/mgt/EgovMeetingManageList";*/
		return "uss/olp/mgt/EgovMeetingManageList";
    ...
    throws Exception {
		...
		String sLocationUrl = "uss/olp/mgt/EgovMeetingManageDetail";
    ...
    throws Exception {
		...
		String sLocationUrl = "uss/olp/mgt/EgovMeetingManageModify";
    ...
    throws Exception {
		...
		String sLocationUrl = "uss/olp/mgt/EgovMeetingManageRegist";
