...
public interface EgovUserManageService  {
	...
	@SuppressWarnings("unchecked")
	public List selectErpUserListPop(UserDefaultVO userSearchVO) throws Exception;
	
	public int selectErpUserListPopTotCnt(UserDefaultVO userSearchVO) throws Exception;
	
	public List selectCarUserListPop(UserDefaultVO userSearchVO) throws Exception;
	
	public int selectCarUserListPopTotCnt(UserDefaultVO userSearchVO) throws Exception;
