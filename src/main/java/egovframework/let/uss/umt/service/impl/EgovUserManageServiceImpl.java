...
public class EgovUserManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserManageService {
	...
	public String insertUser(UserManageVO userManageVO) throws Exception {
		...
		//String pass = EgovFileScrty.encryptPassword(userManageVO.getOldPassword(),userManageVO.getUniqId());
		System.out.println("password : " + pass);
		userManageVO.setPassword(pass);
		
//		String pass = EgovFileScrty.encryptPassword(userManageVO.getPassword(),userManageVO.getUniqId());
//		userManageVO.setPassword(pass);
		//userManageVO.setPassword( EgovFileScrty.encryptPassword(userManageVO.getPassword(), userManageVO.getUniqId()) );
	...
	public List selectErpUserListPop(UserDefaultVO userSearchVO) {
		List result = userManageDAO.selectErpUserListPop(userSearchVO);
		return result;
	}
	public int selectErpUserListPopTotCnt(UserDefaultVO userSearchVO) {
		return userManageDAO.selectErpUserListPopTotCnt(userSearchVO);
	}
	
	@SuppressWarnings("unchecked")
	public List selectCarUserListPop(UserDefaultVO userSearchVO) {
		userManageDAO.sessionAdd();
		List result = userManageDAO.selectCarUserListPop(userSearchVO);
		return result;
	}
	public int selectCarUserListPopTotCnt(UserDefaultVO userSearchVO) {
		return userManageDAO.selectCarUserListPopTotCnt(userSearchVO);
	}
