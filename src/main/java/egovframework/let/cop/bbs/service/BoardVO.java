...
public class BoardVO extends Board implements Serializable {
    ...
    /** 조회용 AUTH_CODE*/
    private String search_authCode = "";
    
    
    public String getSearch_authCode() {
		return search_authCode;
	}

	public void setSearch_authCode(String search_authCode) {
		this.search_authCode = search_authCode;
	}
